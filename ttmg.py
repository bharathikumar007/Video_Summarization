...
def updateCheck(self, Version):
    ...
    check = UpdateChecker()
    check.URL = "https://raw.githubusercontent.com/sudo-ken/FFmpeg-for-GDrive/master/update.xml"
    ...
    if Version != currentVersion:
        ...
        display(HTML('<div style="background-color: #4caf50!important;text-align: center;padding-top:-1px;padding-bottom: 9px;boder:1px"><h4 style="padding-top:5px"><a target="_blank" href="https://bit.ly/sudoken-youtube-channel" style="color: #fff!important;text-decoration: none;color: inherit;background-color:transparent;font-family: Segoe UI,Arial,sans-serif;font-weight: 400;font-size: 20px;">Open Latest Version</a></h4></div>'))
        return True
    else:
